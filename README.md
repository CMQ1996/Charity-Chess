...
![screenshot of navbar](assets\images\navbarshot.png)
### The Header 
...
![Incomplete Signup form](assets/images/Screenshot%202024-08-15%20030920.png)
...
- **HTML:** No issues in W3C Validator for any of the four HTML pages.  
  ![HTML validation screenshot](assets\images\htmlvalidator.png)
    ![HTML validation screenshot](assets\images\activisiteshtml.valid.png)
      ![HTML validation screenshot](assets\images\singnupformvalidator.png)
      ![HTML validation screenshot](assets\images\contact.usvalidator.png)
      ![HTML validation screenshot](assets\images\thankyouhtmlvalid.png)

- **CSS:** No errors in Jigsaw Validator.  
  ![CSS validation screenshot](assets\images\css.validator.png)

- **Accessibility:** Lighthouse confirms site is accessible and SEO-friendly.  
